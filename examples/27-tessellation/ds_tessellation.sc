...
// , ds_facetNormal, ds_patchDistance
...
void main()
{
    ...
    ds_color0 = gl_TessCoord.x * getHullOutput(hs_color0, 0)
              + gl_TessCoord.y * getHullOutput(hs_color0, 1)
              + gl_TessCoord.z * getHullOutput(hs_color0, 2);
